...
interface DdClassToggleProps {
  value: string;
  onChange: (val: string) => void;
  options?: string[];
}

const OPTIONS = ['Unchanged DD', 'Rescheduled'];
const LABEL = 'DD Class';

export function DdClassToggle({ value, onChange, options }: DdClassToggleProps) {
